...
// --- Main Component ---
export const StockTrendsCarousel = React.forwardRef<HTMLDivElement, StockTrendsCarouselProps>(
  ({ title, subtitle, stocks, className }, ref) => {
    ...
    return (
      <section ref={ref} className={cn("w-full max-w-6xl mx-auto space-y-4", className)}>
        {/* Header */}
              ...
              >
                <Card className="w-64 p-4 h-full flex flex-col justify-between border-border/60 hover:border-border transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className={cn("font-semibold", stock.changePercent >= 0 ? "text-green-500" : "text-red-500")}>
