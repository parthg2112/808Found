                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.8rem] text-white/70 font-light">The future of algorithmic trading</p>
                    </div>
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to 808Found</h1>
                      <p className="text-[1.25rem] text-white/50 font-light">Your journey into algorithmic trading starts now.</p>
                    </div>
